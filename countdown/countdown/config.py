...
def setup_logging(level: str | int | None = None) -> logging.Logger:
    """Configure root logging once; honours ``COUNTDOWN_LOG_LEVEL``."""
    global _LOG_CONFIGURED
    if level is None:
        level = os.environ.get("COUNTDOWN_LOG_LEVEL", "INFO")
    ...
    logging.getLogger("countdown").setLevel(level)
    return logging.getLogger("countdown")
