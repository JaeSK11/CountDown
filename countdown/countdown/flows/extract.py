...
from countdown.flows.decode import (
    DLT_EN10MB,
    DLT_IEEE802_11,
    DLT_LINUX_SLL,
    DLT_LINUX_SLL2,
...
from countdown.flows.reassembly import (
    SERVICE_PORTS,
    Reassembler,
    _is_service_port,
    canonical_key,
...
class FlowExtractor:
    ...
    def extract(
        ...
        # top-level import would make `import countdown.sources` and `import
        # countdown.flows` resolve differently depending on which came first.
