...
#: only resolves the key; ``countdown.eval.splits`` is what refuses a grouping that has
...
class FlowDataset:
    ...
    def _extract(self, extractor: str, **kwargs: Any) -> tuple[np.ndarray, list[str]]:
        from countdown.features import get_extractor  # local import: avoids a cycle
