...
from countdown.data import pooled as pooled_mod
from countdown.data.pooled import available_pooled, load_pooled
...
def _fake_loader(monkeypatch, mapping: dict[str, FlowDataset]):
    ...
    monkeypatch.setattr("countdown.data.base.load", fake_load)
