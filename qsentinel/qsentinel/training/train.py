...
2. Bind a :class:`~qsentinel.schema.LabelSpace` -- before any splitting, because it fixes
...
from qsentinel.eval.metrics import evaluate, metrics_excluding_tail
from qsentinel.eval.report import summarize, write_run
from qsentinel.eval.splits import group_split_three, split_report, stratified_split
from qsentinel.models.base import ModelRegistry
...
def train(
    ...
    feat_ds = ds
    if cfg.windows:
        from qsentinel.data.windows import windowed_dataset
