#!/usr/bin/env python3
"""Validate qsentinel's crypto parsing against tshark, and report PQC metrics (task 2.9).
...
from qsentinel.crypto import kem_registry, parse_handshake, pqc_verdict  # noqa: E402
from qsentinel.flows import Reassembler  # noqa: E402
from qsentinel.sources import PcapSource  # noqa: E402
